...
import { CHARACTER, THEME } from "../config/portfolio.config";

const StarIcon = () => (
  <svg width="28" height="28" viewBox="0 0 24 24" fill={THEME.accent} stroke="#c89030" strokeWidth="0.5" strokeLinejoin="round">
